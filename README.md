...
- Data fetching/cache: TanStack React Query u `core/api/query-hooks.ts` i `core/query/query-client.ts`, uz per-user Expo SQLite lokalni cache u `core/cache/local-cache.ts` za event details, chat room metadata i chat poruke.
