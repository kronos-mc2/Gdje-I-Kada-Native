...
Dopuna 2026-05-31: Discover summary overlay prikazuje vrijeme, adresu i broj sudionika kao plain tekst odvojen znakom `|`, a tagove prikazuje u zasebnom bubble redu ispod toga s najvise 5 tagova i overflow bubbleom `+N`. Backend nije mijenjan jer feed DTO vec vraca `address` i `tags`.
